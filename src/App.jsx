...
function App() {
  return (
    <div className="App">
      <Navbar/>
      <div id="home" className="hero flex items-center justify-center flex-row">
        <div className="container px-8 flex flex-wrap flex-row justify-center items-center gap-x-10">
          <div className="portrait-wrapper">
            <img className="embellishment" src={embellishments} alt="" />
