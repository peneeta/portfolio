...
function Education() {
    return(
        <div className="education-section my-10 flex flex-wrap flex-row items-center justify-center gap-x-16 px-16">
            <div className="edu-block flex flex-col items-center justify-center gap-x-8 py-10" data-aos="fade-up">
            ...
            <div className="edu-block flex flex-col items-center justify-center gap-x-8" data-aos="fade-up">
                <div className="school-img mb-6">
