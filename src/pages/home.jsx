    ...
    return(
                ...
                <div className="container px-8 flex flex-wrap-reverse flex-row justify-center items-center gap-x-8">
                    ...
                    <div className="text-wrapper">
                        <div className="headline">
                            <h2 className="mb-1">Hello, my name is</h2>
                            <h1 className="pb-1.5">Peneeta</h1> 
                            <div className="subtitle text-base">
                                <p>Masters student and aspiring genomics researcher, interested broadly in computational biology and laboratory automation.</p>
                            </div>
                        </div>

                    <div className="icons-wrapper flex flex-col justify-start gap-2 mt-8 links">
                        <a className="flex items-center justify-start flex-row gap-8" href="https://www.linkedin.com/in/peneeta/" target="_blank">
                        <div className="icon linkedin">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/></svg>
                        </div> 
                        <p>https://www.linkedin.com/in/peneeta/</p>
                        </a>  

                        <a className="flex items-center justify-start flex-row gap-8"  href="https://github.com/peneeta" target="_blank">
                        ...
                        <p> https://github.com/peneeta</p>
                        </a>

                        <a href="mailto:peneetaannwojcik@gmail.com" className="flex items-center justify-start flex-row gap-8">
                            <div className="icon mail">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 512 512"><path d="M48 64C21.5 64 0 85.5 0 112c0 15.1 7.1 29.3 19.2 38.4L236.8 313.6c11.4 8.5 27 8.5 38.4 0L492.8 150.4c12.1-9.1 19.2-23.3 19.2-38.4c0-26.5-21.5-48-48-48H48zM0 176V384c0 35.3 28.7 64 64 64H448c35.3 0 64-28.7 64-64V176L294.4 339.2c-22.8 17.1-54 17.1-76.8 0L0 176z"/></svg>
                            </div>
                            <p>peneetaannwojcik@gmail.com</p>
                        </a>
                    </div>
                </div>  
            </div>
        ...
        <div className="px-10 section mb-20 flex items-center justify-center" style={{height: "35vh"}}>
            <div className="section-text end my-3">
                ...
                <div className="my-2 flex flex-col justify-center items-start text-left">
                    <a className="flex items-center justify-start flex-row gap-4 links" href="https://www.linkedin.com/in/peneeta/" target="_blank">
                        <p>https://www.linkedin.com/in/peneeta/</p>
                    </a>  

                    <a href="mailto:peneetaannwojcik@gmail.com" className="flex items-center justify-start flex-row gap-4 links">
                        <p>peneetaannwojcik@gmail.com</p>
                    </a>
                </div>
            </div>
